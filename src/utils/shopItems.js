...
export const SHOP_ITEMS = [
  ...
  },
  {
    ...
    itemData: { id: 'shop_ps_i_wand', kind: 'wand', emoji: '✨', name: 'まほうステッキ' },
  },
  {
    id: 'ps_pet_dragon',
    chara: 'princess', cat: 'pet',
    shopEmoji: '🐲', shopName: 'ドラゴンペット', price: 50,
    itemData: { id: 'shop_ps_p_dragon', kind: 'dragon', emoji: '🐲', name: 'ドラゴン' },
  },
  {
    id: 'ps_crown_jewel',
    chara: 'princess', cat: 'crown',
    shopEmoji: '💎', shopName: 'ほうせきかんむり', price: 35,
    itemData: { id: 'shop_ps_c_jewel', kind: 'gem', emoji: '💎', name: 'ほうせき' },
  },
  {
    id: 'ps_acc_fairy',
    chara: 'princess', cat: 'item',
    shopEmoji: '🧚', shopName: 'ようせいのつばさ', price: 45,
    itemData: { id: 'shop_ps_a_fairy', kind: 'bouquet', emoji: '🧚', name: 'つばさ' },
  },
  {
    id: 'ps_dress_gold',
    chara: 'princess', cat: 'dress',
  ...
  },
  {
    ...
    itemData: { id: 'shop_ps_i_mirror', kind: 'parasol', emoji: '🪞', name: 'かがみ' },
  },
  {
    id: 'ps_crown_star',
    chara: 'princess', cat: 'crown',
    shopEmoji: '🌟', shopName: 'スターかんむり', price: 28,
    itemData: { id: 'shop_ps_c_star', kind: 'star', emoji: '🌟', name: 'スター' },
  },
  {
    id: 'ps_acc_angel',
    chara: 'princess', cat: 'item',
    shopEmoji: '😇', shopName: 'てんしのわ', price: 38,
    itemData: { id: 'shop_ps_a_angel', kind: 'rainbow', emoji: '😇', name: 'てんしのわ' },
  },
  ...
  },
  {
    ...
    itemData: { id: 'shop_pr_p_phoenix', kind: 'eagle', emoji: '🦅', name: 'フェニックス' },
  },
  {
    id: 'pr_item_gold_sword',
    chara: 'prince', cat: 'item',
    shopEmoji: '⚔️', shopName: 'おうごんのけん', price: 35,
    itemData: { id: 'shop_pr_i_gold', kind: 'sword', emoji: '⚔️', name: 'おうごんのけん' },
  },
  {
    id: 'pr_pet_lion',
    chara: 'prince', cat: 'pet',
    shopEmoji: '🦁', shopName: 'ライオンペット', price: 30,
    itemData: { id: 'shop_pr_p_lion', kind: 'lion', emoji: '🦁', name: 'ライオン' },
  },
  {
    id: 'pr_acc_shield',
    chara: 'prince', cat: 'item',
    shopEmoji: '🛡️', shopName: 'まほうのたて', price: 25,
    itemData: { id: 'shop_pr_a_shield', kind: 'sword', emoji: '🛡️', name: 'まほうのたて' },
  },
  {
    id: 'pr_item_star_mantle',
    chara: 'prince', cat: 'item',
    shopEmoji: '🌟', shopName: 'ほしのマント', price: 45,
    itemData: { id: 'shop_pr_i_star', kind: 'rainbow', emoji: '🌟', name: 'ほしのマント' },
  },
  {
    id: 'pr_dress_gold',
    chara: 'prince', cat: 'dress',
  ...
  },
  {
    ...
    itemData: { id: 'shop_pr_c_dragon', kind: 'helmet', emoji: '🐲', name: 'ドラゴン' },
  },
  {
    id: 'pr_pet_wolf',
    chara: 'prince', cat: 'pet',
    shopEmoji: '🐺', shopName: 'オオカミペット', price: 35,
    itemData: { id: 'shop_pr_p_wolf', kind: 'wolf', emoji: '🐺', name: 'オオカミ' },
  },
  {
    id: 'pr_item_trumpet',
    chara: 'prince', cat: 'item',
    shopEmoji: '🎺', shopName: 'ぎんのらっぱ', price: 28,
    itemData: { id: 'shop_pr_i_trumpet', kind: 'horn', emoji: '🎺', name: 'らっぱ' },
  },
];
